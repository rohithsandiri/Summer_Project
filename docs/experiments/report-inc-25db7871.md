...
## Timeline of Events
- [07:11:01] Alert Fired: DatabaseUnavailable on service order-service (Severity: critical)
...
- [07:11:01] Decision Generated: Action=Prepare Rollback, Policy=p-test-3, Reason=Critical burn rate threshold (15.00) exceeded for service inventory-service. Initiating immediate automated rollback.
- [07:11:01] State transitioned from Investigating to DecisionMade. Reason: Decision completed: Prepare Rollback
- [07:11:01] Recovery Plan Created: ID=plan-inventory-service-2d19d834, Action=Prepare Rollback, Cooldown=5s
- [07:11:01] State transitioned from DecisionMade to RecoveryPlanned. Reason: Recovery plan created: plan-inventory-service-2d19d834
...
- [07:11:01] Verification Successful. System health restored in 43µs.
