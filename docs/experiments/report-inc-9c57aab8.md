...
## Timeline of Events
- [07:43:44] Alert Fired: HighErrorRate on service payment-service (Severity: critical)
...
- [07:43:44] Decision Generated: Action=Prepare Rollback, Policy=p-test-1, Reason=Critical burn rate threshold (8.00) exceeded for service payment-service. Initiating immediate automated rollback.
- [07:43:44] State transitioned from Investigating to DecisionMade. Reason: Decision completed: Prepare Rollback
- [07:43:44] Recovery Plan Created: ID=plan-payment-service-a64860ef, Action=Prepare Rollback, Cooldown=5s
- [07:43:44] State transitioned from DecisionMade to RecoveryPlanned. Reason: Recovery plan created: plan-payment-service-a64860ef
...
- [07:43:44] Verification Successful. System health restored in 103µs.
