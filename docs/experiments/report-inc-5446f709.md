...
## Timeline of Events
- [07:12:16] Alert Fired: InventoryServiceDown on service inventory-service (Severity: critical)
...
- [07:12:16] Decision Generated: Action=Prepare Rollback, Policy=p-test-2, Reason=Critical burn rate threshold (15.00) exceeded for service inventory-service. Initiating immediate automated rollback.
- [07:12:16] State transitioned from Investigating to DecisionMade. Reason: Decision completed: Prepare Rollback
- [07:12:16] Recovery Plan Created: ID=plan-inventory-service-e4cc4e27, Action=Prepare Rollback, Cooldown=5s
- [07:12:16] State transitioned from DecisionMade to RecoveryPlanned. Reason: Recovery plan created: plan-inventory-service-e4cc4e27
...
- [07:12:16] Verification Successful. System health restored in 42µs.
