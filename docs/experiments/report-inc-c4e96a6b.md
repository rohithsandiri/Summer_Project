...
## Timeline of Events
- [07:13:01] Alert Fired: HighErrorRate on service payment-service (Severity: critical)
...
- [07:13:01] Decision Generated: Action=Prepare Rollback, Policy=p-test-1, Reason=Critical burn rate threshold (8.00) exceeded for service payment-service. Initiating immediate automated rollback.
- [07:13:01] State transitioned from Investigating to DecisionMade. Reason: Decision completed: Prepare Rollback
- [07:13:01] Recovery Plan Created: ID=plan-payment-service-d4d99754, Action=Prepare Rollback, Cooldown=5s
- [07:13:01] State transitioned from DecisionMade to RecoveryPlanned. Reason: Recovery plan created: plan-payment-service-d4d99754
...
- [07:13:01] Verification Successful. System health restored in 102µs.
