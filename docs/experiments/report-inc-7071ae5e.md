...
## Timeline of Events
- [07:28:15] Alert Fired: InventoryServiceDown on service inventory-service (Severity: critical)
...
- [07:28:15] Decision Generated: Action=Prepare Rollback, Policy=p-test-2, Reason=Critical burn rate threshold (15.00) exceeded for service inventory-service. Initiating immediate automated rollback.
- [07:28:15] State transitioned from Investigating to DecisionMade. Reason: Decision completed: Prepare Rollback
- [07:28:15] Recovery Plan Created: ID=plan-inventory-service-51ad2878, Action=Prepare Rollback, Cooldown=5s
- [07:28:15] State transitioned from DecisionMade to RecoveryPlanned. Reason: Recovery plan created: plan-inventory-service-51ad2878
...
- [07:28:15] Verification Successful. System health restored in 57µs.
