...
## Timeline of Events
- [07:12:16] Alert Fired: LatencyP95MaxViolation on service payment-service (Severity: warning)
...
- [07:12:16] Decision Generated: Action=Prepare Rollback, Policy=p-test-4, Reason=Critical burn rate threshold (8.00) exceeded for service payment-service. Initiating immediate automated rollback.
- [07:12:16] State transitioned from Investigating to DecisionMade. Reason: Decision completed: Prepare Rollback
- [07:12:16] Recovery Plan Created: ID=plan-payment-service-cd03cf69, Action=Prepare Rollback, Cooldown=5s
- [07:12:16] State transitioned from DecisionMade to RecoveryPlanned. Reason: Recovery plan created: plan-payment-service-cd03cf69
...
- [07:12:16] Verification Successful. System health restored in 67µs.
