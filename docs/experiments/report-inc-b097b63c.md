...
## Timeline of Events
- [07:25:17] Alert Fired: LatencyP95MaxViolation on service payment-service (Severity: warning)
...
- [07:25:17] Decision Generated: Action=Prepare Rollback, Policy=p-test-4, Reason=Critical burn rate threshold (8.00) exceeded for service payment-service. Initiating immediate automated rollback.
- [07:25:17] State transitioned from Investigating to DecisionMade. Reason: Decision completed: Prepare Rollback
- [07:25:17] Recovery Plan Created: ID=plan-payment-service-390d744f, Action=Prepare Rollback, Cooldown=5s
- [07:25:17] State transitioned from DecisionMade to RecoveryPlanned. Reason: Recovery plan created: plan-payment-service-390d744f
...
- [07:25:17] Verification Successful. System health restored in 87µs.
