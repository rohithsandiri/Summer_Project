...
## Timeline of Events
- [07:25:17] Alert Fired: InventoryServiceDown on service inventory-service (Severity: critical)
...
- [07:25:17] Decision Generated: Action=Prepare Rollback, Policy=p-test-2, Reason=Critical burn rate threshold (15.00) exceeded for service inventory-service. Initiating immediate automated rollback.
- [07:25:17] State transitioned from Investigating to DecisionMade. Reason: Decision completed: Prepare Rollback
- [07:25:17] Recovery Plan Created: ID=plan-inventory-service-1d916d9e, Action=Prepare Rollback, Cooldown=5s
- [07:25:17] State transitioned from DecisionMade to RecoveryPlanned. Reason: Recovery plan created: plan-inventory-service-1d916d9e
...
- [07:25:17] Verification Successful. System health restored in 208µs.
