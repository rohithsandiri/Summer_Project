...
## Timeline of Events
- [07:43:44] Alert Fired: InventoryServiceDown on service inventory-service (Severity: critical)
...
- [07:43:44] Decision Generated: Action=Prepare Rollback, Policy=p-test-2, Reason=Critical burn rate threshold (15.00) exceeded for service inventory-service. Initiating immediate automated rollback.
- [07:43:44] State transitioned from Investigating to DecisionMade. Reason: Decision completed: Prepare Rollback
- [07:43:44] Recovery Plan Created: ID=plan-inventory-service-c56d5374, Action=Prepare Rollback, Cooldown=5s
- [07:43:44] State transitioned from DecisionMade to RecoveryPlanned. Reason: Recovery plan created: plan-inventory-service-c56d5374
- [07:43:44] Executing Rollback (Attempt 1/2) on service inventory-service
...
- [07:43:44] Rollback execution succeeded. Old Revision: 2, Rollback Revision: 1
...
- [07:43:44] Verification Successful. System health restored in 107µs.
