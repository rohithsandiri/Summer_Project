...
## Timeline of Events
- [07:28:15] Alert Fired: DatabaseUnavailable on service order-service (Severity: critical)
...
- [07:28:15] Decision Generated: Action=Prepare Rollback, Policy=p-test-3, Reason=Critical burn rate threshold (15.00) exceeded for service inventory-service. Initiating immediate automated rollback.
- [07:28:15] State transitioned from Investigating to DecisionMade. Reason: Decision completed: Prepare Rollback
- [07:28:15] Recovery Plan Created: ID=plan-inventory-service-a50774f0, Action=Prepare Rollback, Cooldown=5s
- [07:28:15] State transitioned from DecisionMade to RecoveryPlanned. Reason: Recovery plan created: plan-inventory-service-a50774f0
- [07:28:15] Executing Rollback (Attempt 1/2) on service inventory-service
...
- [07:28:15] Rollback execution succeeded. Old Revision: 3, Rollback Revision: 1
...
- [07:28:15] Verification Successful. System health restored in 98µs.
